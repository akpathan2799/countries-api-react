...
const CountryCard = ({image,countryName,population,capital,region}) => {
  ...
  return (
    ...
    <div className="flex flex-col h-full  w-80 rounded-md border border-black dark:border-white bg-white dark:bg-slate-900 shadow-lg transform transition hover:scale-110 self-baseline shadow-lg max-[850px]:w-[300px] max-[450px]:w-[320px] ">
